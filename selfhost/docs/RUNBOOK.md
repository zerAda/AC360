# Runbook — Stack IA privée AC360 (Onyx + Ollama)
...
5. Ouvrir `http://localhost:3000`, créer le **compte admin** (1er compte).
6. Assistant LLM : **Ollama**, URL `http://ollama:11434`, modèle `llama3.2:3b`.
